...
<div id="post-<?php the_ID(); ?>" <?php post_class('entry clearfix ' . $post_class); ?>>
    ...
    <!-- Post Title -->
    <h3 class="entry-title block-title block-title-left"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php _e('ID: ', 'vega'); echo $id; ?></a></h3>
    <?php } else { ?>
    ...
    <div class="entry-image entry-image-two-col">
        ...
        <a class="post-thumbnail post-thumbnail-large" href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'post-thumbnail-large', array( 'alt' => get_the_title(), 'class'=>'img-responsive' ) ); ?></a>
        <?php } else { ?>
        <a class="post-thumbnail post-thumbnail-large" href="<?php the_permalink(); ?>"><img src="<?php vega_wp_random_thumbnail('post-thumbnail-large'); ?>" class="img-responsive" /></a><?php } ?>
    </div>
    ...
    <?php } else if($vega_wp_blog_feed_display == 'Small Image Left, Excerpt Right') { ?>
    ...
    <!-- Post Meta -->
    <div class="entry-meta <?php if($vega_wp_blog_feed_display == 'Small Image Left, Excerpt Right' && $vega_wp_blog_feed_sidebar == 'Y') { ?> entry-meta-right <?php } ?>">
