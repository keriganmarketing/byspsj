...
<div class="section frontpage-cta frontpage-cta2 <?php echo $class ?>" <?php echo $parallax_str; ?> id="<?php echo esc_attr($vega_wp_frontpage_cta_dark2_section_id); ?>">
    <div class="container wow zoomIn">
        <div class="description"><?php echo $vega_wp_frontpage_cta_dark2_content; ?></div>
    </div>
</div>
<!-- ========== /Call to Action ========== -->
<?php 
