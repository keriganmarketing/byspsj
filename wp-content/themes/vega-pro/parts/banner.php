...
<?php #EXAMPLE CONTENT: If demo is on, the example full screen banner will show up regardless of any other settings. ?>

<?php $vega_wp_enable_demo = vega_wp_get_option('vega_wp_enable_demo'); 
if($vega_wp_enable_demo == 'Y' && is_front_page()) { vega_wp_example_fullscreen_banner(); } else { ?>


<?php $custom_header = get_header_image(); if($custom_header == '') $custom_header = $vega_wp_defaults['vega_wp_custom_header']; ?>
<?php  
