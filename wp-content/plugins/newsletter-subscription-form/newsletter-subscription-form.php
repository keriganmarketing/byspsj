 ...
 * Copyright 2016-18  Weblizar (email : lizarweb@gmail.com, twitter : @weblizar)  
 */
...
function nls_settings_link($links) {
	$nls_settings_link = '<a href="admin.php?page=nls-weblizar">Settings</a>';
	$nls_pro_link = '<a style="color: #ea5a21;font-weight: 700;" href="https://weblizar.com/plugins/newsletter-subscription-form-pro/" target="_blank">Go Pro</a>';
