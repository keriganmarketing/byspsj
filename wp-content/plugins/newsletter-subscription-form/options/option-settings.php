...
<div class="col-xs-8 tab-content" id="spa_general"> <!-- plugin dashboard Main class div setting -->
	<div class="tab-pane col-md-12 block ui-tabs-panel active" id="templates-option"> <!-- plugin template selection setting -->	
				...
				<div id="weblizar-template" class="tab-pane fade in active"><!-- plugin template free theme layout selection setting -->		
					<form method="post" id="weblizar_nls_template_option">
						...
						<?php for($i=1; $i<=2; $i++){
						 ...
						 ?>
						<div class="col-md-12 col-sm-6 op_tem site_template <?php if($wl_nls_options['select_template']=='select_template'.$i) echo 'active'; ?>" id="select_template<?php echo $i?>" onclick="pretheme()">	
							<div class="col-md-12 selected_template <?php if($wl_nls_options['select_template']=='select_template'.$i) echo 'active'; ?>">	
								...
								<h4 class="op_name"><?php _e('Theme ', NLS_TEXT_DOMAIN );?><?php echo $i; ?>&nbsp;&nbsp;<a target="_blank" class="nls_temp_demo" href="<?php echo $nls_demo_temp; ?>">View Demo</a></h4>
						...
						<?php for($i=3; $i<=6; $i++){ 
							$nls_demo_temp = "http://demo.weblizar.com/newsletter-subscription-form-pro/template-".$i ;
						?>
						<div class="col-md-12 col-sm-6 op_tem site_template" id="select_template<?php echo $i?>" onclick="protheme()">	
							<div class="selected_template">	
								...
								<h4 class="op_name"><?php _e('Theme '.$i,NLS_TEXT_DOMAIN);?>&nbsp;&nbsp;<a class="nls_temp_demo" target="_blank" href="<?php echo $nls_demo_temp; ?>">View Demo</a></h4>
							</div>
						</div>
						<?php } ?>	
						</div>
						<script>
							function protheme()
							{
								jQuery('#theme-activation').prop('disabled', true).css("cursor", "not-allowed");
							}
							function pretheme()
							{
								jQuery('#theme-activation').prop('disabled', false).css("cursor", "");
							}
						</script>
					</form>								
				</div>
		...
		<div class="col-md-3">			
			<div class="update_pro_button"><a target="_blank" href="https://weblizar.com/plugins/newsletter-subscription-form-pro/" ><?php _e('Buy Now $7', NLS_TEXT_DOMAIN ); ?></a></div> 
								...
								<div class="col-md-6">	
									...
									<select name="theme_font_family" id="theme_font_family" class="form-group">
										<optgroup label="Default Fonts">
							                  <option value="Arial" <?php selected($theme_font, 'Arial' ); ?>>Arial</option>
						                        <option value="Arial Black" <?php selected($theme_font, 'Arial Black' ); ?>>Arial Black</option>
						                        <option value="Courier New" <?php selected($theme_font, 'Courier New' ); ?>>Courier New</option>
						                        <option value="cursive" <?php selected($theme_font, 'cursive' ); ?>>Cursive</option>
						                        <option value="fantasy" <?php selected($theme_font, 'fantasy' ); ?>>Fantasy</option>
						                        <option value="Georgia" <?php selected($theme_font, 'Georgia' ); ?>>Georgia</option>
						                        <option value="Grande"<?php selected($theme_font, 'Grande' ); ?>>Grande</option>
						                        <option value="Helvetica Neue" <?php selected($theme_font, 'Helvetica Neue' ); ?>>Helvetica Neue</option>
						                        <option value="Impact" <?php selected($theme_font, 'Impact' ); ?>>Impact</option>
						                        <option value="Lucida" <?php selected($theme_font, 'Lucida' ); ?>>Lucida</option>
						                        <option value="Lucida Console"<?php selected($theme_font, 'Lucida Console' ); ?>>Lucida Console</option>
						                        <option value="monospace" <?php selected($theme_font, 'monospace' ); ?>>Monospace</option>
						                        <option value="Open Sans" <?php selected($theme_font, 'Open Sans' ); ?>>Open Sans</option>
						                        <option value="Palatino" <?php selected($theme_font, 'Palatino' ); ?>>Palatino</option>
						                        <option value="sans" <?php selected($theme_font, 'sans' ); ?>>Sans</option>
						                        <option value="sans-serif" <?php selected($theme_font, 'sans-serif' ); ?>>Sans-Serif</option>
						                        <option value="Tahoma" <?php selected($theme_font, 'Tahoma' ); ?>>Tahoma</option>
						                        <option value="Times New Roman"<?php selected($theme_font, 'Times New Roman' ); ?>>Times New Roman</option>
						                        <option value="Trebuchet MS" <?php selected($theme_font, 'Trebuchet MS' ); ?>>Trebuchet MS</option>
						                        <option value="Verdana" <?php selected($theme_font, 'Verdana' ); ?>>Verdana</option>
											</optgroup>
						                                    ...
						                                    // that's it
						                                        ...
						                                        if(isset($fonts_list['items'])){
							                                        ...
							                                        foreach( $g_fonts as $g_font) { $font_name = $g_font['family']; ?>
							                                            <option value="<?php echo $font_name; ?>" <?php selected($theme_font, $font_name ); ?>><?php echo $font_name; ?></option><?php 
							                                        }
	...
	<div class="tab-pane col-md-12 block ui-tabs-panel deactive" id="get_pro_version1">
		<h1 style="margin-top: 10px"><?php _e('Recommendations', NLS_TEXT_DOMAIN ); ?></h1>
	...
	<div class="tab-pane col-md-12 block ui-tabs-panel deactive" id="get_pro_version">
		<div class="col-md-12 option">
			<h1><?php _e('Get Premium Version',NLS_TEXT_DOMAIN);?></h1>
